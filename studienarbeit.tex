...
\fancypagestyle{plain}{
	...
	\fancyhead[L]{
		\footnotesize
		Studienarbeit von \\Hanna Huber \& Jörn Seybold\\
		%Entwurf und Druck eines technischen und\\ eines organischen Objekts mit dem Ultimaker 2
	}
	\fancyhead[R]{
...
\begin{document}
	...
	\input{kapitel/xx_deckblatt}
	
	\pagenumbering{roman}
	\pagestyle{plain}
	
	\onehalfspacing
	\renewcommand{\abstractname}{\Large{Zusammenfassung}\vspace*{1em}}
	\include{kapitel/xx_abstract}
