...
\hline 
\end{tabular}{\footnotesize . Studienjahr.}{\footnotesize \par}

{\footnotesize \rule[0.5ex]{1\columnwidth}{1pt}}{\footnotesize \par}

{\footnotesize }%
\begin{tabular*}{16cm}{@{\extracolsep{\fill}}>{\raggedleft}p{4cm}>{\centering}p{4cm}cc}
{\footnotesize Name des Studierenden:} & \multicolumn{3}{l}{\footnotesize \name}\tabularnewline
\cline{2-4} 
...
\cline{2-4} 
{\footnotesize Thema:} & \multicolumn{3}{>{\raggedright}p{11cm}}{\footnotesize \thema}\tabularnewline
\cline{2-4} 
{\footnotesize Betreuer:} & \multicolumn{3}{>{\raggedright}p{11cm}}{\footnotesize \betreuer}\tabularnewline
\cline{2-4} 
{\footnotesize vom:} & {\footnotesize \modulbegin} & {\footnotesize bis:} & {\footnotesize \modulende}\tabularnewline
\cline{2-2} \cline{4-4} 
...
\begin{tabular*}{16cm}{@{\extracolsep{\fill}}>{\centering}p{1mm}p{15cm}}
 & {\footnotesize gemäß \S5(3) der "`Studien- und Prüfungsordnung DHBW Technik"' vom 22.September 2011. Ich habe die vorliegende Arbeit selbstständig verfasst und keine anderen als die angegebenen Quellen und Hilfsmittel verwendet.
}\tabularnewline
\end{tabular*}
...
{\footnotesize \rule[0.5ex]{1\columnwidth}{1pt}}\\
{\footnotesize Robert Bosch GmbH }{\footnotesize \par}

{\footnotesize \hspace{1cm}Aus- und Weiterbildung Feuerbach, Betreuung DHBW Technik }{\footnotesize \par}
...
\begin{tabular*}{16cm}{@{\extracolsep{\fill}}>{\centering}p{2cm}>{\centering}p{2cm}c>{\centering}p{6cm}}
\cline{1-2} \cline{4-4} 
{\footnotesize Ort} & {\footnotesize Datum} & ~ & {\footnotesize Unterschrift, Stempel}\tabularnewline
\end{tabular*}{\footnotesize{} }{\footnotesize \par}